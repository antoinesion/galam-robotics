...
/* --- INFORMATIONS ---
 * Ce fichier propose quelques fonctions utiles pour la source. Pour qu'elles soient entièrement
 * opérationnelles, la fonction Transmit ci-dessous doit cependant être codé. */
